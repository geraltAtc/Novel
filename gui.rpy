...
define gui.accent_color = '#1dacd6'

## Цвет, используемый в текстовой кнопке, когда она не выбрана и не наведена.
define gui.idle_color = '#1dacd6'
...
define gui.text_font = "russianrail-g-pro-medium.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "russianrail-g-pro-medium.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "russianrail-g-pro-medium.ttf"
